...
- Release exception: this experimental package is private with `releaseConfigMode=none`; release-please, trusted publishing, and npm publication are unavailable, and `scripts/release-check.sh` fails closed.
