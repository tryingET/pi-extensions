...
5. `designmd_import_penpot`
6. `designmd_palette_from_text`
7. `designmd_readiness`
...
- OpenPencil: prompt handoff is stable; CLI lint requires installed `open-pencil` and a real `.fig`/`.pen` fixture.
