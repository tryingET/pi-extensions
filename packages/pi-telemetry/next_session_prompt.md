---
summary: "Handoff prompt for package @tryinget/pi-telemetry inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-telemetry
...
- workspace path: `packages/pi-telemetry`
- release component key: `pi-telemetry`
- primary extension entry: `extensions/telemetry.ts`
