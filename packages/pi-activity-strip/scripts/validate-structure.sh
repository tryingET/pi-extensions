...
# summary: "Validates the activity-strip scaffold layout, executables, copier answers, and Markdown frontmatter."
# read_when:
#   - "Changing required activity-strip files or directories, scaffold invariants, or documentation metadata checks."
set -euo pipefail
...
required_files=(
  ...
  "prompts/pi-activity-strip-implementation-planning.md"
  "prompts/pi-activity-strip-security-review.md"
)
