...
`/visible-loop` and `/nexus-loop` intentionally do not have model-callable peer-spawn tool projections; they launch visible child sessions and drive prompt queues through visible-loop state/intercom machinery. Product posture for the package lives in [product-posture.md](./product-posture.md); this contract covers registration/runtime compatibility details.
