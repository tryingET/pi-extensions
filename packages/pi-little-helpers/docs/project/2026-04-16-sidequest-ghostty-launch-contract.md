...
- The automatic ASC observer does **not** inherit that wrapper/new-window latitude. Without an exact controller-process tab target, it stays headless and warns once.
