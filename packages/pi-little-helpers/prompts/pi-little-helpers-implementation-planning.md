...
read_when:
  - "You need a scoped implementation plan before changing pi-little-helpers."
description: Draft an implementation plan for a requested pi-little-helpers change
system4d:
...
Create a pi-little-helpers implementation plan for this request: $@
