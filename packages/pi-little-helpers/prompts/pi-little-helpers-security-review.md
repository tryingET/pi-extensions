...
read_when:
  - "You want a security-focused review of a proposed or implemented pi-little-helpers change."
description: Review a pi-little-helpers change for security risks and mitigations
system4d:
...
Review this pi-little-helpers change for security concerns: $@
