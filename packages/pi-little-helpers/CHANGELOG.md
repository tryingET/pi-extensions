...
## [0.10.2](https://github.com/tryingET/pi-extensions/compare/pi-little-helpers-v0.10.1...pi-little-helpers-v0.10.2) (2026-09-20)
...
* **test:** close owned peer runtimes and bound test files (AK5789) ([a2e0c68](https://github.com/tryingET/pi-extensions/commit/a2e0c681f749bfc998f758af31d35ea1ef9c2f34))
...
* The following workspace dependencies were updated
  * dependencies
    * @tryinget/pi-session-compaction bumped from file:../pi-session-compaction to 0.5.0
  * peerDependencies
    * @tryinget/pi-peer-messaging bumped from * to 0.3.0
