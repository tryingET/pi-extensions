---
summary: "Handoff prompt for package @tryinget/pi-modes inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-modes
...
- workspace path: `packages/pi-modes`
- release component key: `pi-modes`
- primary extension entry: `extensions/mode.ts`
