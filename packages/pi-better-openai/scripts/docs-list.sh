...
# summary: "Resolves and invokes docs-list for the Better OpenAI package from override, local, or global paths."
# read_when:
#   - "Changing Better OpenAI documentation listing resolution, CLI forwarding, or dependency checks."
set -euo pipefail
