---
summary: "Handoff prompt for package @tryinget/pi-evidence-review inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-evidence-review
...
- workspace path: `packages/pi-evidence-review`
- release component key: `pi-evidence-review`
- primary extension entry: `extensions/evidence-review.ts`
