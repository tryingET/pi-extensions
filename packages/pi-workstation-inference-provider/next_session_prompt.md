---
summary: "Handoff prompt for package @tryinget/pi-workstation-inference-provider inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-workstation-inference-provider
...
- workspace path: `packages/pi-workstation-inference-provider`
- release component key: `pi-workstation-inference-provider`
- primary extension entry: `extensions/workstation-inference.ts`
