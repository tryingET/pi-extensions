...
- `autoresearch_runtime_status`
  ...
  - can list the current adapter contract catalog (`action: "adapter_contracts"`, packet kind `autoresearch.adapter_contracts.v1`) so downstream extensions can validate supported packet kinds without scraping docs
