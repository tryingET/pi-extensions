...
Moved to the RFC appendix to keep the decision record readable:
[2026-04-22-pi-autoresearch-self-hosting-rfc-appendix.md#q-worked-examples](2026-04-22-pi-autoresearch-self-hosting-rfc-appendix.md#q-worked-examples).
...
## U) Suggested first implementation slices and open questions

Moved to the RFC appendix to keep the adopted decision focused:
[2026-04-22-pi-autoresearch-self-hosting-rfc-appendix.md#u-suggested-first-implementation-slices](2026-04-22-pi-autoresearch-self-hosting-rfc-appendix.md#u-suggested-first-implementation-slices).
