...
export function rateTemplate(executionId, rating, success, notes, context, options, dependencies) {
  ...
  `);
    ...
    const issuesJson = dependencies.escapeSql(JSON.stringify(success ? [] : ["needs-improvement", `execution:${normalizedExecutionId}`]));
