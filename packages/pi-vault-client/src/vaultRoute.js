...
export function buildRoutePrompt(metaContent, context, options) {
...
export function getRoutePromptShapeForChannel(channel) {
...
export function prepareRoutePrompt(metaTemplate, options) {
