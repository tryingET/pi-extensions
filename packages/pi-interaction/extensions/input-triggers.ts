...
import { registerPickerInteraction, splitQueryAndContext } from "../src/InteractionHelper.js";
import { getBroker } from "../src/TriggerBroker.js";
import { TriggerEditor } from "../src/TriggerEditor.js";
...
// Re-export broker + helper primitives for external extensions.
export { getBroker, resetBroker } from "../src/TriggerBroker.js";
...
export default function (pi: ExtensionAPI) {
  ...
  pi.on("session_start", (_event, ctx) => {
    ...
    ctx.ui.notify("Interaction runtime enabled", "info");
  });
