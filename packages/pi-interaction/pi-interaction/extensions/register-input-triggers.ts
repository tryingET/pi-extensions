// summary: Registers the trigger editor, built-in triggers, and six trigger commands.
// read_when:
//   - Changing the narrow live pi-interaction activation path or command surface.

/**
 * Pi Interaction - Cooperative runtime for live editor interactions.
 *
 * Keep this activation entrypoint registration-only. Public helper exports stay
 * on input-triggers.ts and the package root so startup does not load picker,
 * schema, or interaction-kit modules that registration does not use.
 */
