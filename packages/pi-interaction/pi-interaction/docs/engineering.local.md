---
summary: "Local override notes for the shared engineering-core lane used by this package."
read_when:
...
# engineering.local (pi extension package)
...
- This package now uses the reduced-form local surface: keep this doc for the child-package override note, and keep lane metadata/pinning at the monorepo root instead of shipping `policy/engineering-lane.json`.
