...
- Documented the first release-safe monorepo workflow for `@tryinget/pi-interaction` and clarified that only `packages/pi-interaction/pi-interaction` is the canonical publish target.
