...
export const RIPWIRE_WORKFLOW_GUIDELINES = Object.freeze([
  ...
  'For source details, call context_pack with code.mode="expand" and code.selection={path,name,line,contentSha256}, copied from the exact code.selection.json block in the packet, not its display labels. Do not guess a path, line or hash.',
