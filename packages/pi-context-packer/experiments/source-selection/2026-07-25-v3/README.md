...
Case authors did not inspect rankings or compute scores. Independent repository reviews are recorded in `pre-ranking-review.md`; all five cohorts are accepted after bounded corrections.
