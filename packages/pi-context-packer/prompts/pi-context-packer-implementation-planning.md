---
summary: "pi-context-packer implementation planning prompt template."
read_when:
  - "Using or updating the monorepo package implementation-planning prompt template."
description: Draft an implementation plan for a requested pi-context-packer change
system4d:
...
Create a pi-context-packer implementation plan for this request: $@
