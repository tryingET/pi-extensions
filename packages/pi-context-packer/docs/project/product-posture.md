...
- before choosing more provider work, review whether accumulated evaluated receipts show ranking failures, provider availability failures, accounting/omission mismatches, live reload/registration gaps, or simply correct omissions; wired provider outages should not be treated as planned-unwired adapter gaps;
