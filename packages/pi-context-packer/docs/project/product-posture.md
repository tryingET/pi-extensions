...
- maturity: `internal dogfood / package-cwd workspace-basis, strict docs-list provider contract, provider-route scoping, and receipt-projection accounting hardened MVP with bounded-SCI sandboxing, safety/accounting receipts, local receipt evaluation, and non-persistent aggregate summaries`
