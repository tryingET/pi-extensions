---
summary: "Handoff prompt for package @tryinget/pi-semantic-code-intelligence inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-semantic-code-intelligence
...
- workspace path: `packages/pi-semantic-code-intelligence`
- release component key: `pi-semantic-code-intelligence`
- primary extension entry: `extensions/semantic-code-intelligence.ts`
