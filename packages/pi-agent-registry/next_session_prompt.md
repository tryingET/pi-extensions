---
summary: "Handoff prompt for package @tryinget/pi-agent-registry inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-agent-registry
...
- workspace path: `packages/pi-agent-registry`
- release component key: `pi-agent-registry`
- primary extension entry: `extensions/pi-agent-registry.ts`
