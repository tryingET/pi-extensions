---
summary: "Handoff prompt for package @tryinget/pi-provenance inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-provenance
...
- primary extension entry: `extensions/provenance.ts`
