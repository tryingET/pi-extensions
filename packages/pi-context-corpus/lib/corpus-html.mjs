...
export function renderIndexHtml(index) {
  ...
  const statusClass = { ok: "ok", empty: "empty", failed: "failed" };
...
<table>
<thead><tr><th>session</th><th>status</th><th>models</th><th>reqs</th><th>turns</th><th>faults</th><th>on-chain $</th><th>cache hit</th><th>ghost share</th><th>last resident / window</th><th>runway reqs</th><th>top categories (token-turns)</th></tr></thead>
<tbody>
${rows}
</tbody>
</table>
