---
summary: "Handoff prompt for package @tryinget/pi-snapshot-edit inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-snapshot-edit
...
- workspace path: `packages/pi-snapshot-edit`
- release component key: `pi-snapshot-edit`
- primary extension entry: `extensions/snapshot-edit.ts`
