...
- Execution status: done (exit 0, 56721ms).
- Evidence write outcome: ak.
- Captured output excerpt: ## AXIOMS (Non-Negotiables) - **Behavior is the product:** parser wiring, output, exits, filesystem effects, lazy imports, error envelopes, and private compatibility names must remain identical. - **Existing seams are c…
