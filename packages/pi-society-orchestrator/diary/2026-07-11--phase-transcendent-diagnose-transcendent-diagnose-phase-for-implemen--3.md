...
- Execution status: done (exit 0, 48294ms).
- Evidence write outcome: ak.
- Captured output excerpt: ## AXIOMS (Non-Negotiables) - **Contract truth:** Every public parser operation must have exactly one declaration matching observable writes, required authority, and exit codes. - **Closed vocabulary:** Effects and cond…
