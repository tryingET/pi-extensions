...
- Execution status: done (exit 0, 46529ms).
- Evidence write outcome: ak.
- Captured output excerpt: ## AXIOMS (Non-Negotiables) - **Advisory authority only:** Plans must describe repository evidence and catalog implications without executing commands or claiming runtime/compliance authority. - **Deterministic, version…
