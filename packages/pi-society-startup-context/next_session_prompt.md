---
summary: "Handoff prompt for package @tryinget/pi-society-startup-context inside monorepo workspace."
read_when:
...
# Next session prompt for @tryinget/pi-society-startup-context
...
- workspace path: `packages/pi-society-startup-context`
- release component key: `pi-society-startup-context`
- primary extension entry: `extensions/society-context.ts`
