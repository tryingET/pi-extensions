...
function buildSelfContainedHandoffPrompt(
  ...
  return [
    ...
    "",
    "Current handoff (ASC self mirror-only; not canonical authority)",
    ...
    "- pi-session-compaction owns compaction summaries; ASC may generate this operator-pasteable handoff prompt but must not become the canonical compaction engine.",
