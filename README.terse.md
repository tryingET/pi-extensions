...
| `pi-context-packer` | yes | plan bounded future context packets across source-owned providers | read-only first slice; preserves docs/AK/FCOS/etc. authority boundaries |
