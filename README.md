...
- `packages/pi-eval-kernel` — one model-visible `eval` call backed by disposable Python/JavaScript workers, persistent logical state, and explicit owner-runtime capability adapters; not arbitrary active Pi-tool invocation and not a sandbox
