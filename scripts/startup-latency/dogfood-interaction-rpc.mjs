...
The probe starts a fresh offline RPC Pi process with only the repo-local narrow
pi-interaction registration entrypoint. It invokes all six trigger commands,
...
const extension = resolve(
  repoRoot,
  "packages/pi-interaction/pi-interaction/extensions/register-input-triggers.ts",
);
